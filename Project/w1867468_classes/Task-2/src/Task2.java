...
public class Task2 {
    public static void main(String[] args) {
        ...
        initialise(cabins); // Calling initialise method
        ...
        while (true) {
                        ...
                        if ( cabins[cNumber - 1].passengers[0].getFirstName().equalsIgnoreCase("-") && cabins[cNumber - 1].passengers[1].getFirstName().equalsIgnoreCase("-") && cabins[cNumber - 1].passengers[2].getFirstName().equalsIgnoreCase("-") ) {
                            for ( int x = 1; x <= 3; x = x + 1 ) {
                                ...
                                if ( firstName.contains(" ") || sureName.contains(" ") ) {
                                    ...
                                    Cabin optionA = new Cabin(); // Creating Cabin Object optionA
            ...
            // View all cabins option:
                ...
                Cabin optionV = new Cabin(); // Creating Cabin Object optionV
            ...
            // Display empty cabins option:
                ...
                Cabin optionE = new Cabin(); // Creating Cabin Object optionE
            ...
            // Delete passenger from cabin option:
                ...
                Cabin optionD = new Cabin(); // Creating Cabin Object optionD
            ...
            // Find cabin from passenger name option:
                ...
                Cabin optionF = new Cabin(); // Creating Cabin Object optionF
            ...
            // View passengers ordered alphabetically by name option:
                ...
                alphaSort(cabins); // Calling alphaSort method
            }
            ...
            // Print expenses of a passenger option:
                ...
                Cabin optionT = new Cabin(); // Creating Cabin Object optionT
...
//                else {
//                    String fullName = cabins[x].passengers[y].getFirstName()+" "+cabins[x].passengers[y].getSureName();
//                    sortNames.add(fullName);
//                }
//            }
//        }
//
//        for ( int i = 0; i < sortNames.size() - 1; i = i + 1 ) {
//            int index = i;
//            for ( int j = i + 1; j < sortNames.size(); j = j + 1 ) {
//                if ( sortNames.get(index).compareToIgnoreCase( sortNames.get(j) ) > 0 ) {
//                    index = j;
//                }
//                else {
//                    continue;
//                }
//            }
//            String value = sortNames.get(index);
//            sortNames.set(index,sortNames.get(i));
//            sortNames.set(i,value);
//        }
//
//        System.out.println("Passengers:");
//        for ( int x = 0; x < sortNames.size(); x = x + 1 ) {
//            System.out.println( sortNames.get(x) );
//        }
    }
